...
{ bluetooth.begin(115200);
  ...
  pinMode(in3, OUTPUT);
  pinMode(in4, OUTPUT);
  pinMode(ledtruoc, OUTPUT);
  pinMode(ledsau, OUTPUT);
  pinMode(ledtrai, OUTPUT);
  pinMode(ledphai, OUTPUT);
}
...
void forw () // chay
{
  Serial.println("motor di thang"); motor_right(spd , 0); motor_left( spd , 0);
}
void back () // chay lui
{
  Serial.println("motor di lui"); motor_right(spd , 1); motor_left( spd , 1);
}
void right () // quay trai
{
  Serial.println("motor cua trai"); motor_right(spd , 0); motor_left( spd , 2);
}
void left () // quai phai
{
  Serial.println("motor cua phai"); motor_left( spd , 0); motor_right( spd , 2);
}
void leftforw () // quai phai cham
{
  Serial.println("motor cua phai nhanh"); motor_left( spd - 20 , 0); motor_right( spd , 0);
}
void rightforw () // quai phai nhanh
{
  Serial.println("motor cua trai nhanh "); motor_left( spd , 0); motor_right( spd - 20 , 0);
}
void rightback () // quai phai nhanh
{
  Serial.println("motor cua trai nhanh "); motor_left( spd , 1); motor_right( spd - 20 , 1);
}
void leftback () // quai phai nhanh
{
  Serial.println("motor cua trai nhanh "); motor_left( spd - 20 , 1); motor_right( spd , 1);
}
void tack() {
  motor_left( spd , 2); motor_right( spd , 2);
}
void den_tien() {
...
void robot_android()
{
  ...
  {
    blue = bluetooth.read(); Serial.println("gia tri cua blue la "); Serial.println(blue);
  }
  switch (blue )
  {
    case ('W'):
